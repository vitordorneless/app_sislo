$(document).ready(function () {
    ...
    $("#sislo_vagas_entrevista").validate({
        ...
        submitHandler: function (form) {
            let compareceu_check = $("#compareceu").is(":checked") === true ? 1 : 0;
            ...
            let resp5_1 = $("#resposta5_1").is(":checked") === true ? 1 : 0;
            var resposta5_1 = "&resposta5_1=" + resp5_1;
            ...
            let resp5_2 = $("#resposta5_2").is(":checked") === true ? 1 : 0;
            var resposta5_2 = "&resposta5_2=" + resp5_2;
            ...
            let resp5_3 = $("#resposta5_3").is(":checked") === true ? 1 : 0;
            var resposta5_3 = "&resposta5_3=" + resp5_3;
            ...
            let resp5_4 = $("#resposta5_4").is(":checked") === true ? 1 : 0;
            var resposta5_4 = "&resposta5_4=" + resp5_4;
            ...
            let resp5_5 = $("#resposta5_5").is(":checked") === true ? 1 : 0;
            var resposta5_5 = "&resposta5_5=" + resp5_5;

            $.ajax({
                type: "POST",
                url: BASE_URL + "salva_entrevista",
                dataType: "html",
                data: $(form).serialize() + resposta1_1 + resposta2_1 + resposta3_1 + resposta4_1 + resposta5_1 +
                        resposta1_2 + resposta2_2 + resposta3_2 + resposta4_2 + resposta5_2 +
                        resposta1_3 + resposta2_3 + resposta3_3 + resposta4_3 + resposta5_3 +
                        resposta1_4 + resposta2_4 + resposta3_4 + resposta4_4 + resposta5_4 +
                        resposta1_5 + resposta2_5 + resposta3_5 + resposta4_5 + resposta5_5 + compareceu,
                beforeSend: function () {
                    clearErrors();
