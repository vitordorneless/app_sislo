...
$routes->get('empresa_perfil', 'Sislo_LotericaEmpresa::empresa_perfil');
...
$routes->get('sislo_fechamento_efetivado', 'Sislo_FechamentoCofre::sislo_fechamento_efetivado');
$routes->post('ajax_list_cofre_efetivado', 'Sislo_FechamentoCofre::ajax_list_cofre_efetivado');
...
$routes->get('redireciona_status_vaga', 'Sislo_Vagas::redireciona_status_vaga');
$routes->get('redireciona_fechamento_vaga', 'Sislo_Vagas::redireciona_fechamento_vaga');
...
$routes->post('ajax_save_formbolaoonline', 'Sislo_ComissaoBolaoOnline::ajax_save_form');
$routes->get('redireciona_bolaoonline_edit', 'Sislo_ComissaoBolaoOnline::redireciona_bolaoonline_edit');
//fim 
