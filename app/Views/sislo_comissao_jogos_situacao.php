<div class="card">
    <div class="card-header">
        <h3 class="card-title">Situação Jogos</h3>
    </div>
    <div class="card-body">        
        <div class="row">
            <form class="form-inline" id="sislo_situacao_jogos" method="POST">
                <?php
                $ano = $anos = date('Y');
                $mes = date('m');
                ?>
    ...
    <div class="card-footer" id="conteudo">
        ...
        <div class="row">
            <table id="table_sislo_situacao_jogos" class="table table-striped table-bordered table-responsive text text-sm text-center">
                <thead>
                    <tr>
                        <th>#</th>                                                                        
                        <th>Jogo</th>
