<div class="card">
    <div class="card-header">
        <h3 class="card-title">Relatório Comissão Jogos</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="form-inline">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?= base_url('redireciona_comissao_jogos/?id=0'); ?>">Incluir Comissão</a><br><br>
                </div>
            </div>
        </div>
        <br>
        <div class="row">
            <form class="form-inline" id="sislo_comissao_list" method="POST">
                <?php
                $ano = $anos = date('Y');
                $mes = date('m');
                ?>
    ...
    <div class="card-footer" id="conteudo">
        ...
        <div class="row">
            <table id="table_sislo_comissao_list" class="table table-striped table-bordered table-responsive text text-sm text-center">
                <thead>
                    <tr>
                        <th>Data Inicial</th>
                        <th>Data Final</th>                        
