<div class="card">
    <div class="card-header">
        <h3 class="card-title">Comissão Jogos - IBC!</h3>
    </div>
    <div class="card-body">
        <form class="form-group" id="sislo_comissao_jogos_ibc_loterias" name="sislo_comissao_jogos_ibc_loterias" method="POST">
            <div class="row">
                <div class="col-sm-2">
