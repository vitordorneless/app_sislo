<div class="card">
    ...
    <div class="card-body">
        <form class="form-group" id="sislo_quina" name="sislo_quina" method="POST">
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Concurso</label>
                        <input type="text" id="concurso" required="required" autofocus name="concurso" class="form-control" value="<?= $concurso; ?>">
                        <input type="hidden" id="idsislo_quina" name="idsislo_quina" class="form-control" value="<?= $idsislo_quina; ?>">
