<div class="card">
    <div class="card-header">
        <h3 class="card-title">Comissão Jogos - SILCE!</h3>
    </div>
    <div class="card-body">
        <form class="form-group" id="sislo_comissao_jogos_silce_loterias" name="sislo_comissao_jogos_silce_loterias" method="POST">
            <div class="row">
                <div class="col-sm-2">
                ...
                <table id="dt_fechamento" class="table table-striped table-bordered table-responsive text text-sm text-center">
                    ...
                    <tbody>
                        <tr class="theline">
                            ...
                            <td><input type="text" id="comissao_total" name="comissao_total[]" class="form-control"></td>
                            <td><input type="text" id="participacao" name="participacao[]" class="form-control"></td>
                        </tr>
                    </tbody>
                </table>
            </div>
