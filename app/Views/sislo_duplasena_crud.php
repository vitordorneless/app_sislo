<div class="card">
    <div class="card-header">
        <h3 class="card-title">Dupla-Sena!</h3>
    </div>
    <div class="card-body">
        <form class="form-group" id="sislo_duplasena" name="sislo_duplasena" method="POST">
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Concurso</label>
                        <input type="text" id="concurso" required="required" autofocus name="concurso" class="form-control" value="<?= $concurso; ?>">
                        <input type="hidden" id="idsislo_duplasena" name="idsislo_duplasena" class="form-control" value="<?= $idsislo_duplasena; ?>">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 01</label>
                        <input type="number" min="01" max="60" id="dez_07" required="required" name="dez_07" class="form-control" value="<?= $dez_07; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 02</label>
                        <input type="number" min="01" max="60" id="dez_08" required="required" name="dez_08" class="form-control" value="<?= $dez_08; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 03</label>
                        <input type="number" min="01" max="60" id="dez_09" required="required" name="dez_09" class="form-control" value="<?= $dez_09; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 04</label>
                        <input type="number" min="01" max="60" id="dez_10" required="required" name="dez_10" class="form-control" value="<?= $dez_10; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 05</label>
                        <input type="number" min="01" max="60" id="dez_11" required="required" name="dez_11" class="form-control" value="<?= $dez_11; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 06</label>
                        <input type="number" min="01" max="60" id="dez_12" required="required" name="dez_12" class="form-control" value="<?= $dez_12; ?>">                        
                    </div>
                </div>
            </div>
            <div class="row">
