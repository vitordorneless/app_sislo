<div class="card">
    <div class="card-header">
        <h3 class="card-title">Relatório Cobrança Diária Contas e Serviços</h3>
    </div>
    <div class="card-body">
        <div class="row">
        ...
        <br>
        <div class="row">
            <form class="form-inline" id="sislo_cob_diaria_list" method="POST">
                <?php
                $ano = $anos = date('Y');
                $mes = date('m');
                ?>
    ...
    <div class="card-footer" id="conteudo">
        ...
        <div class="row">
            <table id="table_sislo_cob_caixa_list" class="table table-striped table-bordered table-responsive text text-sm text-center">
                <thead>
                    <tr>
                        <th>Data Inicial</th>
                        <th>Data Final</th>                        
