<div class="card">
    ...
    <div class="card-body">
        <form class="form-group" id="sislo_megasena" name="sislo_megasena" method="POST">
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Concurso</label>
                        <input type="text" id="concurso" required="required" autofocus name="concurso" class="form-control" value="<?= $concurso; ?>">
                        <input type="hidden" id="idsislo_megasena" name="idsislo_megasena" class="form-control" value="<?= $idsislo_megasena; ?>">
