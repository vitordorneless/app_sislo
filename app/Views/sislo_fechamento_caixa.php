<div class="card">
    <div class="card-header">
        <h3 class="card-title">Fechamento de Caixa Operador Lotérico</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="form-inline">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?= base_url('redireciona_fechamento_caixa/?id=0'); ?>">Incluir Fechamento de Caixa Diário</a><br><br>
                </div>
            </div>
        </div>
        <br>
        <div class="row">
            <form class="form-inline" id="sislo_fechamento_caixa_list" method="POST">
                <?php
                $ano = $anos = date('Y');
                $mes = date('m');
                ?>
    ...
    <div class="card-footer" id="conteudo">
        ...
        <div class="row">
            <div class="col-sm-6">
                <label>Soma das Diferenças de Caixas</label>
        ...
        <div class="row">
            <table id="table_sislo_fechamento_caixa_list" name="table_sislo_fechamento_caixa_list" class="table table-striped table-bordered table-responsive text text-sm text-center">
                <thead>
                    <tr>
