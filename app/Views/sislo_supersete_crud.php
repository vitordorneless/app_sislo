<div class="card">
    <div class="card-header">
        <h3 class="card-title">Super Sete!</h3>
    </div>
    <div class="card-body">
        <form class="form-group" id="sislo_supersete" name="sislo_supersete" method="POST">
            <div class="row">
                <div class="col-sm-4">
                    <div class="form-group">
                        <label>Concurso</label>
                        <input type="text" id="concurso" required="required" autofocus name="concurso" class="form-control" value="<?= $concurso; ?>">
                        <input type="hidden" id="idsislo_supersete" name="idsislo_supersete" class="form-control" value="<?= $idsislo_supersete; ?>">
            ...
            <div class="row">
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 01</label>
                        <input type="number" min="0" max="09" id="dez_01" required="required" name="dez_01" class="form-control" value="<?= $dez_01; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 02</label>
                        <input type="number" min="0" max="09" id="dez_02" required="required" name="dez_02" class="form-control" value="<?= $dez_02; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 03</label>
                        <input type="number" min="0" max="09" id="dez_03" required="required" name="dez_03" class="form-control" value="<?= $dez_03; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 04</label>
                        <input type="number" min="0" max="09" id="dez_04" required="required" name="dez_04" class="form-control" value="<?= $dez_04; ?>">                        
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label>Dez. 05</label>
                        <input type="number" min="0" max="09" id="dez_05" required="required" name="dez_05" class="form-control" value="<?= $dez_05; ?>">                        
                    </div>
                </div>
                <div class="col-sm-1">
                    <div class="form-group">
                        <label>Dez. 06</label>
                        <input type="number" min="0" max="09" id="dez_06" required="required" name="dez_06" class="form-control" value="<?= $dez_06; ?>">                        
                    </div>
                </div>
                <div class="col-sm-1">
                    <div class="form-group">
                        <label>Dez. 07</label>
                        <input type="number" min="0" max="09" id="dez_07" required="required" name="dez_07" class="form-control" value="<?= $dez_07; ?>">                        
                    </div>
                </div>
            </div>
            <div class="row">
