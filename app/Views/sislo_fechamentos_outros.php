<div class="card">
    <div class="card-header">
        <h3 class="card-title">Controle Valores lançados por Operador</h3>
    </div>
    <div class="card-body">                
        <div class="row">
            <form class="form-inline" id="sislo_fechamento_caixa_outros_list" method="POST">
                <?php
                $ano = $anos = date('Y');
                $mes = date('m');
                ?>
    ...
    <div class="card-footer" id="conteudo">
        ...
        <div class="row">
            <div class="col-sm-3">
                <label>Soma PIX</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">R$</span>
                    </div>
                    <input type="text" id="sominha_pix" name="sominha_pix" 
                           class="form-control" readonly="readonly">
                </div>
            </div>
            <div class="col-sm-3">
                <label>Soma Azulzinha</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">R$</span>
                    </div>
                    <input type="text" id="sominha_azulzinha" 
                           name="sominha_azulzinha" class="form-control" 
                           readonly="readonly">
                </div>
            </div>
            <div class="col-sm-3">
                <label>Soma Outros</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">R$</span>
                    </div>
                    <input type="text" id="sominha_outros" name="sominha_outros" 
                           class="form-control" readonly="readonly">
                </div>
            </div>
            <div class="col-sm-3">
                <label>Soma Brindes</label>
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        <span class="input-group-text">R$</span>
                    </div>
                    <input type="text" id="sominha_brinde" name="sominha_brinde" 
                           class="form-control" readonly="readonly">
                </div>
            </div>
        </div>
        <div class="row">
            <table id="table_sislo_fechamento_caixa_outros_list" 
                   name="table_sislo_fechamento_caixa_outros_list" 
                   class="table table-striped table-bordered 
                   table-responsive text text-sm text-center">
                <thead>
                    <tr>                        
                        <th>Operador</th>
                        <th>PIX (R$)</th>
