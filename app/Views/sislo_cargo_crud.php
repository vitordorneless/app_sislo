<div class="card">
    <div class="card-header">
        <h3 class="card-title">Dados Cargo</h3>
    </div>
    <div class="card-body">
        <form class="form-group" id="sislo_cargos" name="sislo_cargos" method="POST">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>Nome</label>
                        <input type="text" id="cargo" name="cargo" class="form-control" required="required" value="<?= $cargo; ?>">
                        <input type="hidden" id="id_sislo_cargo" name="id_sislo_cargo" class="form-control" value="<?= $id_sislo_cargo; ?>">
