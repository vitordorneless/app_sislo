<div class="card">
    <div class="card-header">
        <h3 class="card-title">Relatório Comissão Jogos - BOLÃO</h3>
    </div>
    <div class="card-body">
        <div class="row">
            <div class="form-inline">
                <div class="form-group">
                    <a class="btn btn-primary" href="<?= base_url('redireciona_comissao_jogosbolao/?id=0'); ?>">Incluir Comissão de Bolão</a><br><br>
                </div>
            </div>
        </div>
        <br>
        <div class="row">
            <form class="form-inline" id="sislo_comissao_bolao_list" method="POST">
                <?php
                $ano = $anos = date('Y');
                $mes = date('m');
                ?>
