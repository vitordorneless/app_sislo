...
class Sislo_SuperSete extends BaseController {
    ...
    public function index() {
        if ($this->session->get('user_id')) {
            ...
            echo view('sislo_supersete', $data);
    ...
    public function ajax_list_supersete() {
        if ($this->request->isAJAX()) {            
            $sislo_jogos_cef_model = new \App\Models\Sislo_SuperSeteModel;
            ...
            foreach ($sislo as $value) {                
                ...
                $row[] = '<a class="btn btn-primary" href="' . base_url('redireciona_megasena/?id=' . $value->idsislo_supersete) . '">Editar</a>';
                ++$tt;
                ++$tb;
                $data[] = $row;
            }
    ...
    public function redireciona_supersete() {
        if ($this->session->get('user_id')) {
            $sislo_usuarios_model = new \App\Models\Sislo_UsuariosModel;
            $sislo_model = new \App\Models\Sislo_SuperSeteModel;            
            ...
            if ($this->request->getGet('id') == '0') {
                ...
                $dados['idsislo_supersete'] = $dados_loterica->idsislo_supersete;
            ...
            $data = array(
                ...
                "incluir" => $incluir,    
                "jogos" => $jogos,
                "idsislo_supersete" => $dados['idsislo_supersete'],
            ...
            echo view('template/menu');
            echo view('template/content');
            echo view('sislo_supersete_crud', $data);
            echo view('template/footer', $data);
            echo view('template/scripts', $data);
        } else {
            echo view('login');
    ...
    public function ajax_save_form() {
        ...
        if ($this->request->isAJAX()) {
            ...
            if ($this->request->getPost('incluir') == '1') {
                ...
                $sislo_model->where('idsislo_supersete', $this->request->getPost('idsislo_supersete'));
