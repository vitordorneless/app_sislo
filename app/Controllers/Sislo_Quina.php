...
class Sislo_Quina extends BaseController {
    ...
    public function ajax_list_quina() {
        if ($this->request->isAJAX()) {
            $sislo_jogos_cef_model = new \App\Models\Sislo_QuinaModel;
            ...
            foreach ($sislo as $value) {
                ...
                $row[] = '<a class="btn btn-primary" href="' . base_url('redireciona_quina/?id=' . $value->idsislo_quina) . '">Editar</a>';
                ++$tt;
                ++$tb;
                $data[] = $row;
            }
    ...
    public function redireciona_quina() {
        if ($this->session->get('user_id')) {
            $sislo_usuarios_model = new \App\Models\Sislo_UsuariosModel;
            $sislo_model = new \App\Models\Sislo_QuinaModel;
            ...
            if ($this->request->getGet('id') == '0') {
                ...
                $dados['idsislo_quina'] = $dados_loterica->idsislo_quina;
            ...
            $data = array(
                ...
                "incluir" => $incluir,
                "jogos" => $jogos,
                "idsislo_quina" => $dados['idsislo_quina'],
            ...
            echo view('template/menu');
            echo view('template/content');
            echo view('sislo_quina_crud', $data);
            echo view('template/footer', $data);
            echo view('template/scripts', $data);
        } else {
            echo view('login');
    ...
    public function ajax_save_form() {
        ...
        if ($this->request->isAJAX()) {
            ...
            if ($this->request->getPost('incluir') == '1') {
                ...
                $sislo_model->where('idsislo_quina', $this->request->getPost('idsislo_quina'));
