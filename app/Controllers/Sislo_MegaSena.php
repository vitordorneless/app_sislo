...
class Sislo_MegaSena extends BaseController {
    ...
    public function ajax_list_megasena() {
        if ($this->request->isAJAX()) {            
            $sislo_jogos_cef_model = new \App\Models\Sislo_MegaSenaModel;
            ...
            foreach ($sislo as $value) {                
                ...
                $row[] = '<a class="btn btn-primary" href="' . base_url('redireciona_megasena/?id=' . $value->idsislo_megasena) . '">Editar</a>';
                ++$tt;
                ++$tb;
                $data[] = $row;
            }
    ...
    public function redireciona_megasena() {
        if ($this->session->get('user_id')) {
            $sislo_usuarios_model = new \App\Models\Sislo_UsuariosModel;
            $sislo_model = new \App\Models\Sislo_MegaSenaModel;            
            ...
            if ($this->request->getGet('id') == '0') {
                ...
                $dados['idsislo_megasena'] = $dados_loterica->idsislo_megasena;
            ...
            $data = array(
                ...
                "incluir" => $incluir,    
                "jogos" => $jogos,
                "idsislo_megasena" => $dados['idsislo_megasena'],
            ...
            echo view('template/menu');
            echo view('template/content');
            echo view('sislo_megasena_crud', $data);
            echo view('template/footer', $data);
            echo view('template/scripts', $data);
        } else {
            echo view('login');
    ...
    public function ajax_save_form() {
        ...
        if ($this->request->isAJAX()) {
            ...
            if ($this->request->getPost('incluir') == '1') {
                ...
                $sislo_model->where('idsislo_megasena', $this->request->getPost('idsislo_megasena'));
